...
<head>
    ...
    <meta name="description" content="Lego Trades Global | BEST ONLINE EARNING SITE | No. 1 Marketing Forum to Earn Online.">
	<meta name="author" content="Bootlab">
    <title>ADMIN PANEL | Lego Trades Global</title> 
		...
		<nav id="sidebar" class="sidebar">
			<div class="sidebar-content ">
				<a class="sidebar-brand" href="{{url('/')}}">
          			...
          			<span class="align-middle"> Lego Trades Global</span>
        		</a>
				...
				<div class="sidebar-bottom d-none d-lg-block">
					<div class="media">
						...
						<div class="media-body">
							<h5 class="mb-1"> Lego Trades Global</h5>
							<div>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						...
						<div class="col-6 text-right">
							<p class="mb-0">
								&copy; 2020 - <a href="{{url('/')}}" class="text-muted">Lego Trades Global</a>
							</p>
						</div>
					</div>
				</div>
